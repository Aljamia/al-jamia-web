...
const About = () => {
  ...
  return (
    <div>
      <motion.container initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
      ...
      <div className="school-img">
        <div className="btn">
          <Link href="https://www.aljamiaworldcampus.net/" target="_blank">
            <motion.button initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
        ...
        <div className="image">
          <Image unoptimized={true} unselectable={true} src="banner/aljamia.png" alt="photo" width={1000} height={100} style={{ width: "100%", height: "auto" }} />
        </div>
      </div>
    </div>
  );
