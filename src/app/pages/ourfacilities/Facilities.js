    ...
    <div className="facilities">
      ...
      <div className="facilities-header-title">
        ...
        <p className="facilities-desc">
          ...
          inventore in earum sunt velit doloribus, eos illo veritatis excepturi
          consectetur est a totam fuga eaque debitis placeat quidem esse
          ratione!Lorem Lorem ipsum dolor sit, amet consectetur adipisicing
          elit. Labore cumque eum recusandae ipsam, dolores voluptatibus
          reprehenderit sint, mollitia placeat architecto dolorem magni
          provident cupiditate earum officiis iste sapiente temporibus adipisci?
        </p>
      </div>
      <div className="facilities-data">
        ...
        <Container>
          <Row>
            ...
            <Col xl={6}>
              <div className="facilities-data-items">
                <h3>50% of the campus energy is utilized from solar sources</h3>
          ...
          <Row>
            <Col xl={6}>
              <div className="facilities-data-items">
                ...
                <h3>
                  24 Family quarters (for national and international faculties)
                </h3>
                <h3>3 Students corners (outside)</h3>
              </div>
            </Col>
