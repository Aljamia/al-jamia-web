...
const CoursePage = () => {
  ...
  const fields = [
    {
      title: "About course",
      content: <div>Content for About course</div>,
      styleIn: 3,
    },
    {
      title: "Syllabus",
      content: <div>Content for Syllabus</div>,
      styleIn: 2,
    },
    {
      title: "Instructor",
      content: <div>Content for Instructor</div>,
      styleIn: 3,
    },
  ];
          ...
          <>
            <div className="coursePage-header__title">
              <div className="coursePage-header__title__items w-25">
                <h3>{fields[activeField]?.content}</h3>
              </div>
              <div className="coursePage-header__btns">
                <Button variant="secondary" className="button--state-secondary">
                  {" "}
                  <svg
                    width="29"
                    height="29"
            ...
            <div className="coursePage-header__para">
              {course[activeField]?.description || course[0]?.description}
            </div>
            <div>
