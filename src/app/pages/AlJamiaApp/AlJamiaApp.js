    ...
    <div>
      <div className="app_bg">
        <Container>
          <Row>
            <Col xl={6} lg={6} xs={12}>
              <h1 className="app_head">Our App Available ! Download now</h1>
              <p className="app_head">
                ONLINE LEARNING MADE EASIER <br />
                Campus7 facilitates e-learning solutions to deliver online
                training and collaborative solutions to students. Our secure and
                reliable learning platform is customised to meet the functional
                requirements of Educational Institutions. <br />
                <br />
                <p>
                  <Link
