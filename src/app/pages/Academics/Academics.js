...
<h2 className="PreparatoryH2">Handshake infographic mass market <br/> crowdfunding iteration.</h2>
...
<Container>
            ...
            <Col xl={3} lg={6} xs={12}>
                <div className="AboutUspage-mission-img">
                  ...
                  <div class="right-learn-btn"><button class="event-btn-right">Read More</button></div>
                </div>
              </Col>
              <Col xl={3} lg={6} xs={12}>
                <div className="AboutUspage-mission-img">
