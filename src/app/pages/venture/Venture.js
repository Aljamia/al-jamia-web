      ...
      <Container>
        <div className="venture-section">
          ...
          <div className="ventures-cards">
            <div className="card">
              <div className="image">
                <img src="events.png" alt="image" />
              </div>
              <div className="content">
                <h2>Aljamia Off Campus</h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla
                  iste laudantium et rem asperiores aut!
                </p>
                <button>
                  {" "}
                  <span>
            ...
            <div className="card">
              ...
              <div className="content">
                ...
                <Link
                  href="https://www.aljamiaworldcampus.net/"
                  target="_blank"
                >
                  <button>
                    {" "}
