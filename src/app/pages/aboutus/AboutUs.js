...
const AboutUs = () => {
  ...
  return (
    <div className="AboutUspage">
      ...
      <div className="AboutUspage-desc">   <img src="vision.png" alt="photo" className="about_img"/>
          ...
          <Container>
            <Row>
              ...
              <Col xl={6} lg={6} xs={12}>
                ...
                <p className="AboutUspage-mission-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempos Lorem ipsum dolor sitamet, consectetur adipiscing elit, sed do eiusmod 
                <br/><br/>
temporLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempos Lorem ipsum dolor sitamet, consectetur adipiscing elit, sed do eiusmod tempor</p>
              </Col>
...
temporLorem ipsum dolor sit amet, sed do eiusmod tempor  <br/><br/>
temporLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempos Lorem ipsum dolor sitamet, consectetur adipiscing elit, sed do eiusmod tempor</p>
              </Col>
...
<div className="AboutUspage-ourMission p-5">
          <Container>
           ...
           <div className="AboutUspage-campus-title center_aln white"> Work with us</div>
